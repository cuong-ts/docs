...
* [Writing bash shell scripts best practice](linux/writing-bash-shell-scripts-best-practice)
* [Dynamic port mapping for access FTP server](linux/dynamic-port-mapping-for-access-ftp-server)
...
* [Alert slack by hook](others/alert-slack-by-hook)
* [Install redmine on centos 7](others/install-redmine-on-centos-7)
...
* [Postgres create user and grant permistions](databases/postgres-create-user-and-grant-permistions)
* [Install postgres client Amazon Linux 1](databases/install-postgres-client-amazon-linux-1)
